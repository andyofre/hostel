			...
			<div class="min-height-200px"> --}}
                ...
                @endif
					...
					<div class="wizard-content py-3">
						<form action="{{ route('store.register_student') }}" method="POST">
							{{-- <h5>Personal Info</h5> --}}
							...
							<section>
								<div class="row">
									<div class="col-md-6">
										<div class="form-group">
											...
											<input type="text" class="form-control @error('fullName') is-invalid @enderror" name="fullName"  value="{{ $data['name'] }}" readonly>
                                            @error('fullName')
									...
									<div class="col-md-6">
										<div class="form-group">
											...
											<input type="text" class="form-control  @error('matricNumber') is-invalid @enderror" name="matricNumber" value="{{$data['registeration_number']}}" readonly>
                                            @error('matricNumber')
                                            <span class="invalid-feedback" role="alert">
                                                <span>{{ $message }}</span>
                                            </span>
								...
								<div class="row">
									<div class="col-md-6">
										<div class="form-group">
											...
											<input type="text" class="form-control @error('department') is-invalid @enderror" name="department" value="{{$data['department']}}" readonly>
                                            @error('department')
                                            <span class="invalid-feedback" role="alert">
                                                <span>{{ $message }}</span>
                                            </span>
									...
									<div class="col-md-6">
										<div class="form-group">
											<label>Faculty</label>
											<input type="text" class="form-control @error('faculty') is-invalid @enderror" name="faculty" value="{{$data['faculty']}}" readonly>
                                            @error('department')
                                            <span class="invalid-feedback" role="alert">
                                                <span>{{ $message }}</span>
                                            </span>
								...
								<div class="row">
									<div class="col-md-6">
										<div class="form-group">
											<label>Level</label>
                                                <input type="text" class="form-control @error('level') is-invalid @enderror" name="level" value="{{$data['level']}}" readonly>
                                                @error('level')
                                                <span class="invalid-feedback" role="alert">
                                                    <span>{{ $message }}</span>
                                                </span>
                                ...
                                <div class="row">
									...
									{{-- <div>
										<input type="" class="form-control" name="gender" value="">
									</div> --}}
								</div>
