                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('fullName') is-invalid @enderror" name="hostel_name" value="{{ $hostel->hostel_name }}">
                            @error('hostel_name')
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('number_of_rooms') is-invalid @enderror" name="number_of_rooms" value="{{ $hostel->number_of_rooms }}">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <textarea name="description_location" cols="20" rows="5" class="form-control" >
                                {{ $hostel->description_location}}
                            </textarea>
