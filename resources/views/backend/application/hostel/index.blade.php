...
@include('sweetalert::alert')
    ...
    <div class="pd-ltr-20 xs-pd-20-10">
        <div class="min-height-200px">
            <div class="page-header">
                <div class="row">
                    ...
                    <div class="col-md-6 col-sm-12 text-right">
                        <div class="dropdown">
                            <a class="btn btn-primary" href="{{ route('hostelCreate') }}">
                               Add New
                            </a>
					...
					<div class="pb-20">
						<table class="table hover table-bordered multiple-select-row data-table-export nowrap">
							...
							<tbody>
								...
								<tr>
									<td class="table-plus">{{ $hostel->id }}</td>
									<td>{{ $hostel->hostel_name }}</td>
									<td>{{ $hostel->hostel_type }}</td>
									<td>{{$hostel->number_of_rooms }}</td>
									<td>{{ $hostel->description_location }}</td>
									<td>
                                        <div>
                                            <a href="{{ route('hostelEdit',$hostel->id) }}"><span class="icon-copy ti-pencil-alt mr-1"></span></a>


                                                <a href="{{ $hostel->id }}" data-toggle="modal" data-target="#confirmation-modal" type="button"><span class="icon-copy ti-trash fs-40 mx-2" ></span></a>
            ...
            <div class="modal fade" id="confirmation-modal" tabindex="-1" role="dialog" aria-hidden="true" {{ $hostel->id}}>
                    ...
                    <div class="modal-content">
                        <div class="modal-body text-center font-18">
                            ...
                            <div class="padding-bottom-30 row" style="max-width: 170px; margin: 0 auto;">
                                ...
                                <div class="col-6">
                                {{-- <form action="{{route('hostel.delete', $hostel->id) }}" method="post"> --}}
                                        @csrf
                                        @method('DELETE')
